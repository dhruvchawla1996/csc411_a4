...
>>>>>>> 6a5e170ce258799bd9f6c7843c2004b205ed7232
\end{python}
...
Refer to Figure \ref{fig:part5a}. One hyperparameter that was changed was $\gamma$. Initially it was set to $\gamma = 1$, but changing it to $\gamma = 0.75$ incentivized the AI to finish the game in shorter number of turns, which helped penalize ties and invalid  moves. 
\begin{figure}[h]
